...
import 'package:instagram_clone/presentation/screen/profile/Profile.dart';
...
List<PersistentBottomNavBarItem> navBarItems({height, width}) {
  return [
    ...
    PersistentBottomNavBarItem(
      icon: Icon(Icons.search, color: Colors.white, size: height * 0.04),
      inactiveIcon:
          Icon(Icons.search, color: Colors.white, size: height * 0.035),
    ),
    PersistentBottomNavBarItem(
        icon: Container(
